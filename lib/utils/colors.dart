...
class AppColors {
  ...
  static const Color mainColor = Color(0xFF89dad9);
  static const Color mainColorAlt = Color(0xFFfa7552);
  static const Color iconColor1 = Color(0xFFffd28d);
  static const Color iconColor2 = Color(0xFFfcab88);
  static const Color coColor = Color(0xFF8f837f);
  ...
  static const Color yellowColor = Color(0xFFffd372);
}
